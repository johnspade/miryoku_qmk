...
#elif defined (MIRYOKU_CLIPBOARD_MAC_DVORAK)
  #define U_RDO S(G(KC_SLASH))
  #define U_PST LCTL(KC_DOT)
  #define U_CPY LCTL(KC_I)
  #define U_CUT LCTL(KC_B)
  #define U_UND LCTL(KC_SLASH)
